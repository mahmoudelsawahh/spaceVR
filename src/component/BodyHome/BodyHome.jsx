    ...
    >
      ...
      >
        <Box
          ...
          className="planetBox"
        >
          <h1 className="headerImg" style={{ color: "#fff", fontSize: "25px" }}>
            <span>01</span> Pick your DESTINATiON
          </h1>
          <Canvas className="canvas">
            <Suspense fallback={null}>{planets()}</Suspense>
          </Canvas>
        </Box>
        <Box sx={{ flexGrow: 1 }} />
        ...
        <Box sx={{ width: { lg: "40%", xs: "100%" } }} className="test">
          <Box>
            ...
            >
              <h2
                style={{ color: moon ? "#1890ff" : "#fff", cursor: "pointer" }}
                className={moon ? "borderBottom" : null}
                onClick={() => {
                  setEarth(false);
                  setVenus(false);
                  setNeptune(false);
              ...
              <h2
                style={{ color: earth ? "#1890ff" : "#fff", cursor: "pointer" }}
                className={earth ? "borderBottom" : "null"}
                onClick={() => {
                  setEarth(true);
                  setVenus(false);
                  setNeptune(false);
              ...
              <h2
                style={{ color: venus ? "#1890ff" : "#fff" }}
                className={venus ? "borderBottom" : null}
                onClick={() => {
                  setEarth(false);
                  setVenus(true);
                  setNeptune(false);
              ...
              <h2
                style={{
                  color: neptune ? "#1890ff" : "#fff",
                  cursor: "pointer",
                }}
                className={neptune ? "borderBottom" : null}
                onClick={() => {
                  setEarth(false);
                  setVenus(false);
                  setNeptune(true);
          ...
          <Box sx={{ display: "flex", alignItems: "center", width: "95%" }}>
            <Box sx={{ width: "50%" }}>
              <Typography sx={{ color: "#fff" }} variant="h6" mb={2}>
                AVG, distance
              </Typography>
              <h2 style={{ color: "#fff" }} variant="h4">
                {desPlanets().distance}
              </h2>
            </Box>
            <Box sx={{ width: "50%" }}>
